...
var ctx = canvasTable1.getContext("2d");
if (ctx) {
  // Retrieve the data from the table
  var data = {};
  var rows = myChart1.rows;

  for (var i = 1; i < rows.length; i++) {
    var country = rows[i].cells[0].innerText.trim();
    var dataValues = [];
    for (var j = 1; j < rows[i].cells.length; j++) {
      var value = rows[i].cells[j].innerText.trim().replace(",", ".");
      if (value === ":") {
        value = 0;
      } else {
...
// const ctx2 = document.getElementById("table2").getContext("2d");
...
//     var country2 = rows2[i].cells[1].innerText.trim();
//     var dataValues2 = [];
//     for (var j = 2; j < rows2[i].cells.length; j++) {
//       var value2 = rows2[i].cells[j].innerText.trim().replace(",", ".");
//       if (value2 === ":") {
//         value2 = 0;
//       } else {
//         value2 = parseFloat(value2);
//       }
//       dataValues2.push(value2);
//     }
//     data2[country2] = dataValues2;
//   }
...
//         {
//           label: "2007-2009",
//           data: Object.values(data2).map(item => item[2]),
//           backgroundColor: "rgba(255, 99, 132, 0.2)",
//           borderColor: "rgba(255, 99, 132, 1)",
//           borderWidth: 1,
//         },
//         {
//           label: "2010-2012",
//           data: Object.values(data2).map(item => item[3]),
//           backgroundColor: "rgba(54, 162, 235, 0.2)",
//           borderColor: "rgba(54, 162, 235, 1)",
//           borderWidth: 1,
//         },
